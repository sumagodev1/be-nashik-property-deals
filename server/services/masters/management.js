...
const MASTER_LABELS = Object.freeze({
  ...
  status_type:      'Status',
  // Lookup keys — labels surface in the admin sidebar + page titles.
  ...
  road_front_type:             'Road front type',
  land_type:                   'Land type',
  land_zone:                   'Land zone',
  ...
  payment_white_percent:       'Payment (white) %',
  token_amount:                'Token amount',
  booking_amount_percent:      'Booking amount %',
  ...
  tdr_floor:                   'TDR floor',
  amenities_residential:       'Residential amenities',
  amenities_bunglow_furniture: 'Bunglow furniture',
  amenities_plot:              'Plot amenities',
  amenities_commercial:        'Commercial amenities',
  amenities_hostel:            'Hostel amenities',
  ...
  allotted_area_to_owner:      'Allotted area to owner',
  ...
  tdr_zone:                    'TDR Zone',
  pre_leased_project_type:     'Pre-Leased Property / Project Type',
